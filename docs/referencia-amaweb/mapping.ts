type RuleHandler = (elements: any, results: any, nodes: any, rule: any) => void;

const act_mapping: Record<string, RuleHandler> = {
  "QW-ACT-R1": QW_ACT_R1,
  "QW-ACT-R2": QW_ACT_R2,
  "QW-ACT-R4": QW_ACT_R4,
  "QW-ACT-R5": QW_ACT_R5,
...
const wcag_mapping: Record<string, RuleHandler> = {
...
const bp_mapping: Record<string, RuleHandler> = {
  "QW-BP1": QW_BP1,
  "QW-BP2": QW_BP2,
  "QW-BP4": QW_BP4,
  "QW-BP5": QW_BP5,
...
// function QW_WCAG_T16 disabled — mapping entry commented out
...
// function QW_WCAG_T32 disabled — mapping entry commented out
...
// function QW_WCAG_T28 disabled — mapping entry commented out
...
// function QW_BP15 disabled — mapping entry commented out
...
// function QW_BP18 disabled — mapping entry commented out
  ...
  if (technique.metadata.outcome === "passed") {
    ...
    if (multipleH1.length !== 0) {
      ...
      addToNodes(
        nodes,
        "notOneh1",
        technique.results.filter((t: any) => t.resultCode === "F2")
      );
    }
  }
}
...
function addToNodes(nodes: any, key: string, elements: any[] | null | undefined): void {
  nodes[key] = elements;
}
